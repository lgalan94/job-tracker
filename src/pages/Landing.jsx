...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col">
      ...
      {/* Navbar */}
      <nav className="flex justify-between items-center px-8 py-5 bg-gray-800 shadow-lg">
        <h1 className="text-2xl font-bold text-white">JobTracker</h1>
        <div className="flex items-center gap-4">
          {user ? (
            <>
              {/* User Info */}
              <div className="flex items-center gap-2 bg-gray-700 px-3 py-1.5 rounded-lg shadow">
                {user.picture ? (
                  <img
                    src={user.picture}
                    alt={user.name}
      ...
      <section className="px-8 py-20 text-center">
        <img src="/logo.png" alt="Logo" className="mx-auto rounded-lg  w-50 h-50" />
        <h2 className="text-4xl md:text-6xl font-bold leading-tight">
          Track Your Job Applications <br />
          <span className="text-blue-500">Like a Pro.</span>
        </h2>
        <p className="mt-5 text-lg max-w-2xl mx-auto text-gray-300">
        ...
        <div className="mt-8 flex justify-center gap-4 flex-col sm:flex-row items-center">
          {!user && (
            <a
              ...
              className="flex items-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-lg text-lg hover:bg-blue-700 font-semibold shadow"
            >
              <img
      ...
      <section className="px-8 py-16 bg-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          <div className="p-8 bg-gray-700 rounded-xl shadow hover:shadow-lg transition-shadow">
