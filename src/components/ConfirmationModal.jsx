    ...
    >
      <div className="bg-gray-800 rounded-lg shadow-2xl w-full max-w-md border border-gray-700">
        <div className="p-6 flex items-start">
          ...
          <div className="grow">
            <h3 id="confirm-dialog-title" className="text-xl font-bold text-gray-100">
              {title}
            </h3>
        ...
        <div className="p-4 bg-gray-900/50 border-t border-gray-700 flex justify-end gap-4">
          ...
          <button
            onClick={onConfirm}
            className={`px-4 py-2 bg-red-600 text-white font-semibold rounded-md hover:bg-red-700 flex items-center justify-center gap-2 ${
